local function TeleportMenu()
	...
	menu:AddButton("Blume CTOS Server Farm (Outside)", "Intro Mission Location", function()
		just_tp(-613.188721, -1358.770752, 16.090664)
	end)
	menu:AddButton("Blume CTOS Server Farm (Serverroom)", "Intro Mission Location", function()
	...
	menu:AddButton("Blume Campus (Serverroom)", "This is the Air Gap computer", function()
		Script().tp_state:LoadLayer("sf_08_blume_campus_sas")
