local function TeleportMenu()
	...
	menu:AddButton("Prototype Test Arena [Broken]", function()
		Script().tp_state:LoadLayer_and_tp("sv_02_securityplex_lma_protolab", -444.528809, 2209.663086, 14.492650)
	end)
	menu:AddButton("Prototype Test Arena Entrance [Broken]", function()
		Script().tp_state:LoadLayer_and_tp("sv_02_securityplex_lma_protolab", -448.882202, 2140.413330, 15.505307)
	end)
	menu:AddButton("Prototype Test Generator Room [Broken]", function()
		Script().tp_state:LoadLayer_and_tp("sv_02_securityplex_lma_protolab", -449.645660, 2228.059082, 44.9474953)
	end)
