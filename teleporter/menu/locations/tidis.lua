local function TeleportMenu()
	...
	menu:AddButton("Prototype Test Arena", "You control the Spider Bot here.", function()
		Script().tp_state:LoadLayer_and_tp("sv_02_securityplex_lma_protolab01", -444.528809, 2209.663086, 14.492650)
	end)
	menu:AddButton("Prototype Test Arena Entrance", "You control the Spider Bot here.", function()
		Script().tp_state:LoadLayer_and_tp("sv_02_securityplex_lma_protolab01", -448.882202, 2140.413330, 15.505307)
	end)
	menu:AddButton("Prototype Test Generator Room", "You control the Spider Bot here.", function()
